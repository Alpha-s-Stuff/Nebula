...
public class FluidInfo {
    ...
    public void register(Identifier id) {
        ...
        block = Registry.register(Registry.BLOCK, id, new FluidBlock((FlowableFluid) still, FabricBlockSettings.copy(Blocks.WATER)));
        bucket = Registry.register(Registry.ITEM, id, new BucketItem(still, new FabricItemSettings()));
    }
}
